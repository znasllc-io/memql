...
//
// The account read backs all three facets -- the header's name and role, the
// Account facts, the Security tab's policy switch -- so it is read ONCE at
// the layout and passed down. A hook per tab would re-run the query on every
// tab change, which is a visible flicker on a page whose whole content is
// four short facts.
//
...
// actor.userId and take no user id at all -- and both writes resolve their
// target from the verified caller rather than from an argument. This module
