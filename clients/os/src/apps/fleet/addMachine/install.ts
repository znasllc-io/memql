...
/** The runbook's one-liner. Multi-line with trailing backslashes, exactly as
 *  the runbook prints it -- a single 200-character line is unreadable in a
 *  panel and no easier to paste. */
