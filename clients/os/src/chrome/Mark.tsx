  ...
  return (
    ...
    >
      ...
      <g fill="currentColor" stroke="none">
        <circle cx="13.09" cy="2.52" r="1.53" />
        <circle cx="4.30" cy="5.32" r="1.53" />
        <circle cx="9.45" cy="6.83" r="1.53" />
        <circle cx="19.70" cy="8.76" r="1.53" />
        <circle cx="2.52" cy="14.24" r="1.53" />
        <circle cx="13.58" cy="16.07" r="1.53" />
        <circle cx="17.92" cy="17.85" r="1.53" />
        <circle cx="9.40" cy="20.70" r="1.53" />
