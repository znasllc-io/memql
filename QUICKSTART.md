...
[docs/guides/env-vars.md](docs/guides/env-vars.md) for the full
...
- **Architecture:** [docs/core/arch.md](docs/core/arch.md)
- **Write your first automation:** [automations/CLAUDE.md](automations/CLAUDE.md)
- **MemQL gotchas:** [docs/core/memql-authoring-rules.md](docs/core/memql-authoring-rules.md) -- read before authoring `.memql` files
