...
export interface CreateAuditEventArgs {
  ...
  // Enum: user | session | identity | invitation | accessRequest | config | magicLinkRequest | authCode | clusterSettings | deviceCode | delegation | workerPairingCode | enrolmentToken | passkeyIdentity | badgeIdentity | appSession | shopifyStore | releaseCut
  targetType?: string;
  targetId?: string;
  targetEmail?: string;
