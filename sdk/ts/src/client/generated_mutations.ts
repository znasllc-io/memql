...
// Bound concept: v1:library:folder (machine-readable: BoundConcepts["deleteLibraryFolder"] in generated_concepts.ts).
export interface DeleteLibraryFolderArgs {
  folderId: string;
}

export function buildDeleteLibraryFolder(args: DeleteLibraryFolderArgs): string {
  const parts: string[] = [];
  parts.push("folderId: " + renderMemQLValue(args.folderId));
  return "mutation deleteLibraryFolder(" + parts.join(", ") + ")";
}

declare module "./query.js" {
  interface QueryClient {
    deleteLibraryFolder(args: DeleteLibraryFolderArgs, opts?: QueryCallOptions): Promise<Result>;
  }
}

QueryClient.prototype.deleteLibraryFolder = function (this: QueryClient, args: DeleteLibraryFolderArgs = {} as DeleteLibraryFolderArgs, opts?: QueryCallOptions): Promise<Result> {
  return this.executeNamed("deleteLibraryFolder", buildDeleteLibraryFolder(args), opts);
};
...
/** Prune a decayed v1:memory:belief: status -> 'pruned' (soft-delete; the append-only model has no row removal). Recall (#585) + consolidation dedup filter `row.status == "active"`, so a pruned belief drops out of both while staying in the audit trail. ownerUserId re-stamped from actor.userId (owned tier). */
...
/** Save the CALLER's desktop document. Creates the row on the first save and overwrites it on every save after that.
...
// Bound concept: v1:os:desktop (machine-readable: BoundConcepts["saveMyDesktop"] in generated_concepts.ts).
export interface SaveMyDesktopArgs {
  revision: number;
  document: Record<string, unknown>;
}

export function buildSaveMyDesktop(args: SaveMyDesktopArgs): string {
  const parts: string[] = [];
  parts.push("revision: " + renderMemQLValue(args.revision));
  parts.push("document: " + renderMemQLValue(args.document));
  return "mutation saveMyDesktop(" + parts.join(", ") + ")";
}

declare module "./query.js" {
  interface QueryClient {
    saveMyDesktop(args: SaveMyDesktopArgs, opts?: QueryCallOptions): Promise<Result>;
  }
}

QueryClient.prototype.saveMyDesktop = function (this: QueryClient, args: SaveMyDesktopArgs = {} as SaveMyDesktopArgs, opts?: QueryCallOptions): Promise<Result> {
  return this.executeNamed("saveMyDesktop", buildSaveMyDesktop(args), opts);
};
...
// Bound concept: v1:library:artifact (machine-readable: BoundConcepts["setArtifactAccounts"] in generated_concepts.ts).
export interface SetArtifactAccountsArgs {
  artifactId: string;
  accountIds?: string[];
}

export function buildSetArtifactAccounts(args: SetArtifactAccountsArgs): string {
  const parts: string[] = [];
  parts.push("artifactId: " + renderMemQLValue(args.artifactId));
  if (args.accountIds !== undefined) parts.push("accountIds: " + renderMemQLValue(args.accountIds));
  return "mutation setArtifactAccounts(" + parts.join(", ") + ")";
}

declare module "./query.js" {
  interface QueryClient {
    setArtifactAccounts(args: SetArtifactAccountsArgs, opts?: QueryCallOptions): Promise<Result>;
  }
}

QueryClient.prototype.setArtifactAccounts = function (this: QueryClient, args: SetArtifactAccountsArgs = {} as SetArtifactAccountsArgs, opts?: QueryCallOptions): Promise<Result> {
  return this.executeNamed("setArtifactAccounts", buildSetArtifactAccounts(args), opts);
};
...
// Bound concept: v1:platform:site (machine-readable: BoundConcepts["updateSiteAccount"] in generated_concepts.ts).
export interface UpdateSiteAccountArgs {
  siteId: string;
  accountId?: string;
}

export function buildUpdateSiteAccount(args: UpdateSiteAccountArgs): string {
  const parts: string[] = [];
  parts.push("siteId: " + renderMemQLValue(args.siteId));
  if (args.accountId !== undefined) parts.push("accountId: " + renderMemQLValue(args.accountId));
  return "mutation updateSiteAccount(" + parts.join(", ") + ")";
}

declare module "./query.js" {
  interface QueryClient {
    updateSiteAccount(args: UpdateSiteAccountArgs, opts?: QueryCallOptions): Promise<Result>;
  }
}

QueryClient.prototype.updateSiteAccount = function (this: QueryClient, args: UpdateSiteAccountArgs = {} as UpdateSiteAccountArgs, opts?: QueryCallOptions): Promise<Result> {
  return this.executeNamed("updateSiteAccount", buildUpdateSiteAccount(args), opts);
};
...
// Bound concept: v1:platform:site (machine-readable: BoundConcepts["updateSiteShopperForms"] in generated_concepts.ts).
export interface UpdateSiteShopperFormsArgs {
  siteId: string;
  shopperForms: boolean;
}

export function buildUpdateSiteShopperForms(args: UpdateSiteShopperFormsArgs): string {
  const parts: string[] = [];
  parts.push("siteId: " + renderMemQLValue(args.siteId));
  parts.push("shopperForms: " + renderMemQLValue(args.shopperForms));
  return "mutation updateSiteShopperForms(" + parts.join(", ") + ")";
}

declare module "./query.js" {
  interface QueryClient {
    updateSiteShopperForms(args: UpdateSiteShopperFormsArgs, opts?: QueryCallOptions): Promise<Result>;
  }
}

QueryClient.prototype.updateSiteShopperForms = function (this: QueryClient, args: UpdateSiteShopperFormsArgs = {} as UpdateSiteShopperFormsArgs, opts?: QueryCallOptions): Promise<Result> {
  return this.executeNamed("updateSiteShopperForms", buildUpdateSiteShopperForms(args), opts);
};
