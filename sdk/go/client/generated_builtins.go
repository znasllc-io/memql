...
func KnowledgeAugmentDomainAnalyzeBuild(args KnowledgeAugmentDomainAnalyzeArgs) string {
	...
	b.WriteString(quoteMemQLString(args.UserQuestion))
	if b.Len() > 38 {
		b.WriteString(", ")
	}
	b.WriteString("agentResponse: ")
	b.WriteString(quoteMemQLString(args.AgentResponse))
	if b.Len() > 38 {
		b.WriteString(", ")
	}
...
func KnowledgeAugmentDomainGenerateBuild(args KnowledgeAugmentDomainGenerateArgs) string {
	...
	b.WriteString("topic: ")
	b.WriteString(quoteMemQLString(args.Topic))
...
func RecallBuild(args RecallArgs) string {
	...
	if args.Concept != "" {
		...
		b.WriteString(quoteMemQLString(args.Concept))
	}
	if args.K != 0 {
		if b.Len() > 15 {
			b.WriteString(", ")
