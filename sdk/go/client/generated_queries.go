...
func ActiveAgentsBuild(args ActiveAgentsArgs) string {
	...
	if args.GroupId != "" {
		...
		b.WriteString(quoteMemQLString(args.GroupId))
	}
	b.WriteString(")")
	return b.String()
}
...
func AuthSessionByRefreshTokenHashBuild(args AuthSessionByRefreshTokenHashArgs) string {
	...
	b.WriteString(quoteMemQLString(args.RefreshTokenHash))
	b.WriteString(")")
	return b.String()
}
...
func EventsByDayBuild(args EventsByDayArgs) string {
	...
	b.WriteString(quoteMemQLString(args.DayStart))
	if b.Len() > 18 {
		b.WriteString(", ")
	}
	b.WriteString("dayEnd: ")
	b.WriteString(quoteMemQLString(args.DayEnd))
	b.WriteString(")")
	return b.String()
}
...
func ExpiredPendingAccessRequestsBuild(args ExpiredPendingAccessRequestsArgs) string {
	...
	if args.CreatedBefore != "" {
		...
		b.WriteString(quoteMemQLString(args.CreatedBefore))
	}
	b.WriteString(")")
	return b.String()
}
...
func LibraryArtifactByIdBuild(args LibraryArtifactByIdArgs) string {
	...
	b.WriteString(quoteMemQLString(args.ArtifactId))
	b.WriteString(")")
	return b.String()
}
...
func NotesByTagBuild(args NotesByTagArgs) string {
	...
	b.WriteString("tag: ")
	b.WriteString(quoteMemQLString(args.Tag))
	b.WriteString(")")
	return b.String()
}
...
func RecordsByStateBuild(args RecordsByStateArgs) string {
	...
	if args.ValidationState != "" {
		...
		b.WriteString(quoteMemQLString(args.ValidationState))
	}
...
func SkillNeedsRefreshBuild(args SkillNeedsRefreshArgs) string {
	...
	b.WriteString(quoteMemQLString(args.StaleDomainId))
	b.WriteString(")")
	return b.String()
}
...
func SpaceMediaBuild(args SpaceMediaArgs) string {
	...
	if args.MediaType != "" {
		...
		b.WriteString(quoteMemQLString(args.MediaType))
	}
	b.WriteString(")")
	return b.String()
}
...
func SpaceUtterancesBuild(args SpaceUtterancesArgs) string {
	...
	if args.UtteranceType != "" {
		...
		b.WriteString(quoteMemQLString(args.UtteranceType))
	}
	b.WriteString(")")
	return b.String()
}
...
func StaleClusterNodesBuild(args StaleClusterNodesArgs) string {
	...
	if args.OlderThan != "" {
		...
		b.WriteString(quoteMemQLString(args.OlderThan))
	}
	b.WriteString(")")
	return b.String()
}
...
func UpcomingEventsBuild(args UpcomingEventsArgs) string {
	...
	b.WriteString(quoteMemQLString(args.WindowStart))
	if b.Len() > 21 {
		b.WriteString(", ")
	}
	b.WriteString("windowEnd: ")
	b.WriteString(quoteMemQLString(args.WindowEnd))
	b.WriteString(")")
	return b.String()
}
