...
const (
	...
	// spelling, kept as a parse-time name so the statement parser can
	// refuse it (trigger_schedule_synonym_retired): @trigger(schedule=...)
	// is the one spelling (memql#5375).
	AttrTrigger  = "trigger"
	AttrFilter   = "filter"
