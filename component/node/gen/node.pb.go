...
// `partition` is the tenant partition so multi-tenant workbench
// deployments scope correctly.
...
func (x *WorkbenchForwardRequest) GetPartition() string {
	if x != nil {
		return x.Partition
	}
	return ""
...
const file_node_proto_rawDesc = "" +
	...
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\"\x80\x03\n" +
	"\x17WorkbenchForwardRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12L\n" +
	"\x04auth\x18\x02 \x03(\v28.znasllc.memql.node.v1.WorkbenchForwardRequest.AuthEntryR\x04auth\x12\x1c\n" +
	"\tpartition\x18\x03 \x01(\tR\tpartition\x12\x17\n" +
