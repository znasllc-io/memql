...
func defaultRoutingRules() []RoutingRule {
	core := []RoutingRule{
		...
		{Pattern: "graph.node.created.v1:compose:template", TargetType: ""},
		{Pattern: "graph.node.updated.v1:compose:template", TargetType: ""},
		{Pattern: "graph.node.deleted.v1:compose:template", TargetType: ""},
