...
func (e *MemQLEngine) initBuiltinExecutorHandlers() error {
	handlers := map[string]builtinExecutorHandler{
		...
		BuiltinExecutorAutomationGraph: func(ctx context.Context, _ map[string]any, _ int) ([]memorynodes.MemoryNode, error) {
			return e.evaluateAutomationGraphExpression(ctx)
		},
		BuiltinExecutorAutomationLoopStops: func(ctx context.Context, _ map[string]any, _ int) ([]memorynodes.MemoryNode, error) {
			return e.evaluateAutomationLoopStopsExpression(ctx)
		},
		...
		BuiltinExecutorFleetModels: func(ctx context.Context, _ map[string]any, _ int) ([]memorynodes.MemoryNode, error) {
			return e.evaluateFleetModelsExpression(ctx)
		},
		...
		BuiltinExecutorFleetPullRecommended: func(ctx context.Context, args map[string]any, _ int) ([]memorynodes.MemoryNode, error) {
			return e.evaluateFleetPullRecommendedExpression(ctx, args)
		},
		BuiltinExecutorFleetModelProbe: func(ctx context.Context, args map[string]any, _ int) ([]memorynodes.MemoryNode, error) {
			return e.evaluateFleetModelProbeExpression(ctx, args)
		},
		BuiltinExecutorFleetRecommended: func(ctx context.Context, args map[string]any, _ int) ([]memorynodes.MemoryNode, error) {
			return e.evaluateFleetRecommendedExpression(ctx, args)
		},
