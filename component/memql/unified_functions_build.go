...
// which the file's domain is read; the grammar is the parser's
// DefaultOptions, as at boot.
//
...
// and it builds one construct at a time because such a gate compares one
// grammar's build of a construct against another's.
