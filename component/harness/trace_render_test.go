...
func TestTraceRender_ContainsHeaderAndTimeline(t *testing.T) {
	...
	events := []TraceEvent{
		{At: at(base, 0), Kind: EventKindPlan, NodeID: "p1", Status: PlanStatusOpen, Mutation: "createHarnessPlan", Actor: "u1", Content: "the goal"},
		{At: at(base, 1), Kind: EventKindStep, NodeID: "s1", StepID: "s1", Status: StepStatusRunning, Mutation: "startHarnessStep", Actor: "system", Content: "do it"},
