...
func (x *SuggestNextVersionRequest) GetEnv() string {
	if x != nil {
		return x.Env
	}
	return ""
...
func (x *CutVersionRequest) GetEnv() string {
	if x != nil {
		return x.Env
	}
	return ""
...
const file_deploy_control_proto_rawDesc = "" +
	...
	"\x19SuggestNextVersionRequest\x12\x10\n" +
	"\x03env\x18\x01 \x01(\tR\x03env\"S\n" +
