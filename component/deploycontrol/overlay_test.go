...
images:
  ...
  - name: acrmemql.azurecr.io/memql-examplepack
  ...
  - name: acrmemql.azurecr.io/exampleapp
...
func TestParseOverlayShortNames(t *testing.T) {
	...
	want := map[string]bool{
		"memql-identity": true, "memql-examplepack": true, "memql-cognition": true,
		"memql-voice": true, "memql-agent": true, "memql-planner": true,
		"memql-workbench": true, "exampleapp": true,
	}
	got := map[string]bool{}
