...
// (memql#4578).
//
// IT IS NOT A MODE OF Rebuild, AND THE SECOND STEP IS IDENTICAL TO IT. Two
// documents rather than one with a flag, because they are two things an
// operator asks for: "test what I have" and "test the latest with what I have".
// A flag would make the second reachable from the button labelled the first,
// which is the one mistake here that surprises somebody holding uncommitted
// work.
//
