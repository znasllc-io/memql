...
//
//go:embed all:cluster all:cognition all:common all:data all:identity all:knowledge all:memql all:platform all:policies all:providers all:router all:worker
