...
func TestTraceRender_ContainsHeaderAndTimeline(t *testing.T) {
	...
	events := []TraceEvent{
		{At: at(base, 0), Kind: EventKindRun, NodeID: "p1", Status: RunStatusRunning, Mutation: "createWorkRun", Actor: "u1", Content: "the goal"},
		{At: at(base, 1), Kind: EventKindStep, NodeID: "s1", StepID: "s1", Status: StepStatusRunning, Mutation: "createWorkStep", Actor: "system", Content: "do it"},
		...
		{At: at(base, 3), Kind: EventKindRun, NodeID: "p1", Status: RunStatusSucceeded, Mutation: "updateWorkRun", Actor: "system", Content: "the goal"},
	}
