...
var standardDomains = []StandardDomain{
	...
	{ID: "business_administration", Name: "Business Administration", Category: "core",
		...
		RelevantForRoles: []string{"assistant", "accounting_finance", "human_resources", "customer_service", "quality_assurance", "sales_marketing", "it_support", "legal_compliance", "operations", "project_management", "research_development", "training_education"},
	},
	...
	{ID: "executive_calendar", Name: "Executive Calendar Management",
	...
	{ID: "meeting_management", Name: "Meeting Management",
	...
	{ID: "requirements_engineering", Name: "Requirements Engineering",
		Description: "Eliciting, specifying, validating, and managing requirements through a project lifecycle."},
	{ID: "process_modeling", Name: "Process Modeling",
	...
	{ID: "procurement_sourcing", Name: "Procurement & Sourcing",
	...
	{ID: "prioritization_frameworks", Name: "Prioritization Frameworks",
	...
	{ID: "ux_principles", Name: "UX Principles",
	...
	{ID: "experimental_design", Name: "Experimental Design",
	...
	{ID: "documentation_systems", Name: "Documentation Systems",
	...
	{ID: "layout_design", Name: "Layout Design",
	...
	{ID: "publishing_industry", Name: "Publishing Industry",
	...
	{ID: "lyric_writing", Name: "Lyric Writing",
	...
	{ID: "middle_school_pedagogy", Name: "Middle School Pedagogy",
		Description: "Grades 6-8 methods, adolescent development, content-area literacy, project-based learning."},
	{ID: "prealgebra_algebra", Name: "Prealgebra & Algebra I",
	...
	{ID: "high_school_pedagogy", Name: "High School Pedagogy",
	...
	{ID: "geometry_trigonometry", Name: "Geometry & Trigonometry",
	...
	{ID: "physics_high_school", Name: "Physics (High School)",
	...
	{ID: "physics", Name: "Physics",
		...
		BroadSurvey: true},
	{ID: "classical_mechanics", Name: "Classical Mechanics",
	...
	{ID: "quantum_mechanics", Name: "Quantum Mechanics",
	...
	{ID: "planetary_science", Name: "Planetary Science",
	...
	{ID: "philosophy_history", Name: "History of Philosophy",
	...
	{ID: "vaccination_schedules", Name: "Vaccination Schedules", Tier: "B",
	...
	{ID: "psychology_fundamentals", Name: "Psychology Fundamentals",
	...
	{ID: "refrigerant_handling", Name: "Refrigerant Handling", Tier: "B",
	...
	{ID: "joinery_techniques", Name: "Joinery Techniques",
	...
	{ID: "metallurgy_basics", Name: "Metallurgy Basics",
		Description: "Metal properties, alloys, heat treatment, common materials in fabrication."},
	{ID: "weld_inspection", Name: "Weld Inspection",
	...
	{ID: "voting_election_basics", Name: "Voting & Elections",
	...
	{ID: "destination_research", Name: "Destination Research",
	...
	{ID: "film_appreciation", Name: "Film Appreciation",
...
var roleDomainMap = map[string][]string{
	"assistant": {"inventory_supply_chain", "financial_data", "employee_records", "customer_relations", "product_catalog", "quality_metrics", "legal_documents", "project_data", "technical_documentation", "strategic_planning", "stakeholder_communications"},
...
- Knowledge tab (assistant role ONLY): createAgent.domain.business_administration ("Business Administration", the org-wide baseline domain; locked-on for the GA. Specialists do NOT have this locked -- the row is opt-in like any other domain).
...
- Skills tab, integrations sub-tab (locked for Assistant role ONLY; specialists do not get it locked and can opt in): createAgent.integration.copresent_control (ties the GA to the CoPresent Control feature so she can drive the UI on the user's behalf).

CREATE SPACE (route modal:createSpace): createSpace.assistant -- a PINNED non-clickable row at the top of the agent selector. Shows the owner's GA name plus the subtitle "Assistant - Joins automatically". It is a <div>, not a button, so it has no aria-pressed, no checkbox, and no onClick -- uiClick is a category error here, not just a no-op. The backend auto-joins the GA via the autoJoinSI automation regardless of what the picker sends, so there is nothing to toggle. The legacy phrasing "the GA does not appear in the selector" is outdated -- it IS visible, just locked.

CREATE GROUP (route modal:group): createGroup.assistant -- a PINNED non-clickable row at the top of the agents picker, rendered ONLY when the signed-in user is a selected member of this group. Subtitle: "Assistant - Joins because you're a member". Same <div>-not-button semantics as the Create Space pinned row. The GA auto-joins because its owner (the current user) is in the group; if the user removes themselves from the member list, the pinned row disappears and the GA no longer auto-joins.
