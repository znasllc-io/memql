...
//
// Adding this TestMain is what makes `integrations/shopify` a db-gated
// package, which obliges the db-tests lane selector in
// .github/workflows/ci.yml to name it -- scripts/cidb/dbgate_test.go asserts
// that in both directions (memql#2886).
