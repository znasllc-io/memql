...
> [memql-authoring-rules.md](../core/memql-authoring-rules.md#12-partition-is-a-reserved-payload-field----use-partitionname)).
...
- **Writer-vs-reader enforcement inside a partition.** The
  ...
  mutations. Tracked in [ROADMAP.md](../ROADMAP.md).
...
- [identity-service.md](identity-service.md) -- operator-side
  narrative.
- [docs/core/memql-authoring-rules.md](../core/memql-authoring-rules.md)
- [docs/ROADMAP.md](../ROADMAP.md) -- deferred follow-up work.
