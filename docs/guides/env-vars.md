...
**Companion doc:** [`copresent/docs/guides/env-vars.md`](../../../copresent/docs/guides/env-vars.md) covers the frontend side.
...
See [docs/auth/identity-service.md](../auth/identity-service.md) for
