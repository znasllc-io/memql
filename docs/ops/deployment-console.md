...
[deployment-v2](../design/deployment-v2.md) machinery -- "what is
...
- Disaster recovery:
  [`docs/ops/dr-runbook.md`](dr-runbook.md)

## References

- Deployment Console epic: znasllc-io/memql#724 (children #725-#729 +
  cockpit#144/#145).
- Deployment-v2 design + epic: [`docs/design/deployment-v2.md`](../design/deployment-v2.md), #697.
- Supervised live cutovers: #712.
- Owner/admin role model: [`docs/auth/access-model.md`](../auth/access-model.md).
- Machine identity the gate uses: [`docs/auth/service-account-jwt.md`](../auth/service-account-jwt.md), #691.
