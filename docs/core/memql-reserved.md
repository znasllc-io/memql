...
|-------|------|-----------|-------|
| `id` | string | mutation execution | Canonical id format: `{partition}:{concept}:{contentHash}`. See [identifiers.md](identifiers.md). |
...
in `docs/core/memql-authoring-rules.md` (gotcha #19).
...
When the import-model refactor lands ([dsl-import-model-refactor.md](../dsl-import-model-refactor.md)),
