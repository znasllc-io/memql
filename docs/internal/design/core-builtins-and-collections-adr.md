...
| `memqlVersion` | ~~expr~~ retired | **ambient** | hard-retired as an expression builtin under 2026.08 (#2620 ruling / #2707); survives only as the client meta-command (registry builtin `serviceVersion`, alias `memqlVersion`) |
