...
var embedInventory = map[string]int{
	...
	"github.com/znasllc-io/memql/scripts/install/graph":  4,   // install.json uninstall.json (memql#3369; +rebuild.json memql#4245; +install-main.json memql#4430)
}
