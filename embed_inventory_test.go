...
var embedInventory = map[string]int{
	...
	"github.com/znasllc-io/memql/component/identity/web":          11,  // static/* legal/*.md (admin-settings-branding.js went with the settings page, memql#3324; +passkey-login.js, memql#3407)
